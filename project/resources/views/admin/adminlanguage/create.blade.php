                            ...
                            <div class="featured-keyword-area">
                              ...
                              <div class="lang-tag-top-filds" id="lang-section">
                                ...
                                <div class="lang-area">
                                  ...
                                  <div class="row">
                                    <div class="col-lg-6">
                                      <textarea name="keys[]" class="input-field" placeholder="Enter Language Key" required="">FAQs Page</textarea>
                                    </div>

                                    <div class="col-lg-6">
                                      <textarea  name="values[]" class="input-field" placeholder="Enter Language Value" required="">FAQs Page</textarea>
                                    </div>
                                  </div>
                                </div>
