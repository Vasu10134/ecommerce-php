			...
			<div class="row">
				<div class="col-lg-12 remove-padding">
					<div class="content">
						...
						@php
							$___curr = Session::has('currency') ? DB::table('currencies')->where('id','=',Session::get('currency'))->first() : DB::table('currencies')->where('is_default','=',1)->first();
							$___code = $___curr ? strtoupper(trim($___curr->name)) : '';
							$___sign = $___curr ? trim($___curr->sign) : '';
							$___map = ['USD'=>'$','EUR'=>'€','INR'=>'₹','GBP'=>'£','JPY'=>'¥','CNY'=>'¥','NGN'=>'₦','BDT'=>'৳','BRL'=>'R$','AUD'=>'A$','CAD'=>'C$','ZAR'=>'R','KES'=>'KSh','UGX'=>'USh'];
							if($___sign === '/=') { $___sign = 'USh'; }
							$___display = $___map[$___code] ?? ($___sign !== '' ? $___sign : $___code);
						@endphp
									<span>{{ $___display }}</span>
            ...
            <div class="modal-body">
                        ...
                        <div class="order-tracking-content">
                            <form id="track-form" class="track-form">
                                ...
                                <button type="button" data-toggle="modal" data-target="#order-tracking-modal" class="d-none"></button>
                            </form>
                        </div>
