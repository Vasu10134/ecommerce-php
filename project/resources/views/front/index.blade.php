...
@section('content')
	...
	<!-- Featured Links Section - Always Visible -->
			...
			<div class="row">
				<div class="col-lg-3 decrease-padding">
					<div class="featured-link-box">
						<h4 class="title">
								{{ $langg->lang831 ?? 'Featured Links' }}
						</h4>
						<ul class="link-list">
							@foreach(DB::table('featured_links')->get() as $data)
							<li>
								<a href="{{ $data->link }}" target="_blank"><img src="{{ $data->photo ? asset('assets/images/featuredlink/'.$data->photo) :  asset('assets/images/noimage.png') }}" alt="" style="width: 20px; height: 20px; margin-right: 8px; vertical-align: middle;">{{ $data->name }}</a>
							</li>
							@endforeach
						</ul>
					</div>
							...
							<div class="intro-carousel">
								<div class="intro-content">
									<div class="slider-content">
										...
										<div class="layer-2">
											<p class="text">Discover amazing products at great prices</p>
										</div>
									</div>
								</div>
							</div>
